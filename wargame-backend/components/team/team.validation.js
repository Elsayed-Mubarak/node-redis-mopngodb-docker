...
const signupSchema = {
  ...
  country: joi.string ().required ().pattern (/^[a-zA-Z ]+$/).messages ({
    'string.base': `country must be only characters and not empty`,
    'string.empty': `country cannot be an empty field`,
    'string.pattern.base': `country must be only characters`,
